/* AgroMatch spatial studies — original WebGL geometry; no runtime dependencies. */
const Spatial = (() => {
  ...
  class World {
    ...
    dispose(){this.dead=true;cancelAnimationFrame(this.raf);this.resizeObserver?.disconnect();if(this.gl){this.gl.deleteProgram(this.program);this.gl.getExtension('WEBGL_lose_context')?.loseContext()}}
  }
